...
export default function TopNav() {
    return (
        <header className="bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-30 h-16 transition-all duration-200">
                ...
                <div className="flex items-center gap-3 sm:gap-4">
                    ...
                    <div className="hidden md:flex items-center relative group">
                        ...
                        <input
                            type="text"
                            placeholder="Search..."
                            className="pl-9 pr-4 py-1.5 w-64 text-sm bg-slate-100 border-none rounded-full focus:ring-2 focus:ring-indigo-500/20 text-slate-900 placeholder:text-slate-400 transition-all"
                        />
                    </div>
