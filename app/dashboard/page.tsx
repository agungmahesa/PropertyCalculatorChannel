        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
            ...
            <main className="container-custom py-8 space-y-8">
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <KPICard title="Total Revenue" value="IDR 45.2M" change="+12.5%" trend="up" icon={CurrencyDollarIcon} />
                    <KPICard title="Avg. Occupancy" value="85%" change="+4.2%" trend="up" icon={UserGroupIcon} />
                    <KPICard title="Active Channels" value="4 OTAs" change="Stable" trend="up" icon={BuildingStorefrontIcon} />
                    <KPICard title="Avg. Lead Time" value="14 Days" change="-2 days" trend="down" icon={ClockIcon} />
                </section>
                ...
                <section className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <Card className="lg:col-span-8 flex flex-col h-full">
                        ...
                        <CardContent className="flex-1 min-h-[300px] flex items-center justify-center bg-slate-50 dark:bg-slate-900/50 rounded-lg border border-dashed border-slate-200 dark:border-slate-800 m-1">
                            <span className="text-slate-400 text-sm font-medium">Revenue Chart Visualization Area</span>
                        </CardContent>
                    </Card>
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        ...
                        <div className="bg-gradient-to-br from-indigo-600 to-violet-600 rounded-xl p-6 text-white shadow-lg">
                            ...
                            <p className="text-indigo-100 text-sm mb-6 opacity-90">Calculate net profit instantly for a new reservation request.</p>
                            <Link href="/dashboard/calculator" className="w-full">
                                <Button className="w-full bg-white text-indigo-600 hover:bg-slate-100 border-none shadow-none">
                                    Open Calculator
                                </Button>
                            </Link>
                        </div>
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                <div className="flex items-start gap-3 pb-3 border-b border-slate-100 dark:border-slate-800 last:border-0 last:pb-0">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-slate-700 dark:text-slate-200">Agung Commission Updated</p>
                                        <p className="text-xs text-slate-500 dark:text-slate-400">Agoda commission increased to 18%</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-slate-700 dark:text-slate-200">Occupancy Target Met</p>
                                        <p className="text-xs text-slate-500 dark:text-slate-400">You reached 85% occupancy this week</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                {[1, 2, 3].map((i) => (
                                    <tr key={i} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/50 transition-colors">
                                        <td className="px-6 py-4 font-medium text-slate-900 dark:text-slate-200">Deluxe Room {i}</td>
                                        <td className="px-6 py-4 text-slate-500 dark:text-slate-400">Agoda</td>
                                        <td className="px-6 py-4 text-slate-900 dark:text-slate-200">IDR 1,500,000</td>
                                        <td className="px-6 py-4 text-emerald-600 font-medium">+IDR 1,125,000</td>
                                        <td className="px-6 py-4"><Badge variant="success">75%</Badge></td>
