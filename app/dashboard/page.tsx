...
export default async function DashboardPage() {
    ...
    try {
        const [scenariosData, channels, properties, revenueResult] = await Promise.all([
        ...
        totalProfit = revenueResult._sum.netProfit || 0;
    } catch (e: any) {
        console.error('Production Data Fetch Error:', e);
